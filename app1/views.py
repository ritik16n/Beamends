...
def index(request):
    user=request.user
    return render(request,'app1/base.html',{'user':user,})
...
def register(request):
    ...
    return render(request,'app1/registration/register.html',{'form':form,})

def login(request,redirect_field_name='/app1/prehome/'):
    if request.POST:
        ...
        if form.is_valid():
            ...
            if user is not None and user.is_active:
                auth.login(request,user)
                return HttpResponseRedirect('/app1/prehome')
            else:
...
def homepage(request,user_id):
    ...
    if request.user.is_authenticated() and request.user.is_active:
        ...
        return render(request,'app1/userprofile/homepage.html',{'user':user,'datechart':cht,})
    else:
        return render(request,'app1/userprofile/error.html')

@login_required(redirect_field_name='/app1/add', login_url='/accounts/login/')
    ...
    if request.user.is_active:
        if request.user.is_authenticated():
            ...
            if request.POST:
                ...
                form=Linkform()
            return render(request,'app1/userprofile/add.html',{'form':form,})
        else:
            return render(request,'app1/userprofile/error.html')

@login_required(redirect_field_name='/app1/log/', login_url='/accounts/login/')
def log(request,user_pk):
    if request.user.is_authenticated():
        ...
        if request.user.is_active and request.user.id == user.id:
            ...
            return render(request,'app1/userprofile/log.html',{'data':data,})
        else:
            return render(request,'app1/userprofile/error.html')
    else:
        return render(request,'app1/userprofile/error.html')
        ...
        if request.user.is_authenticated():
            ...
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    return render_to_response('app1/userprofile/display.html',{'data':data,'grand_total':grand_total,'user':user,})
            else:
                form=InpurDateForDisplay()
            return render(request,'app1/userprofile/displayform.html',{'form':form,})
    else:
        return render(request,'app1/userprofile/error.html')
        ...
        if request.user.is_authenticated():
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    return render(request,'app1/userprofile/selectedit.html',{'data':data,'user':user,})
            else:
                form=InpurDateForDisplay()
            return render(request,'app1/userprofile/editform.html',{'form':form,})
        ...
        if request.user.is_authenticated():
            ...
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    return render_to_response('app1/userprofile/done.html',{'user':user,})
            else:
                form=Linkform(initial={'date':obj.date,'item':obj.item,'quantity':obj.quantity,'price':obj.price,'description':obj.description,})
            return render(request,'app1/userprofile/foredit.html',{'form':form,'d_id':d_id,'user_id':user_id,})
    ...
    if request.user.id==user.id and request.user.is_active:
        if request.user.is_authenticated():
            if request.session.get('is_deleted',False):
                ...
                form=InpurDateForDisplay()
                return render(request,'app1/userprofile/deleteform.html',{'form':form,})
            if request.POST:
                form=InpurDateForDisplay(request.POST)
                if form.is_valid():
                    dt=form.cleaned_data['dt']
                    ...
                    return render_to_response('app1/userprofile/selectdelete.html',{'data':data,'user':user,})
            else:
                form=InpurDateForDisplay()
            return render(request,'app1/userprofile/deleteform.html',{'form':form,})
    else:
...
def delete(request,d_id,user_id):
    ...
    obj.delete()
    user.save()
    return render_to_response('app1/userprofile/done.html')
        ...
        if request.user.is_authenticated():
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    return render_to_response('app1/userprofile/daterange.html',{'rangedata':rangedata,'user':user,'grand_total':grand_total,})
            else:
                form=DateRangeForm()
            return render(request,'app1/userprofile/dateform.html',{'form':form,})
    else:
        return render(request,'app1/userprofile/error.html')

def settings(request,user_pk):
    user=User.objects.get(id=user_pk)
    return render_to_response('app1/userprofile/settings.html',{'user':user,})
        ...
        if request.user.is_authenticated():
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    user.save()
                    return HttpResponseRedirect('/app1/saved')
            else:
                form=ChangeUsername()
            return render(request,'app1/userprofile/changeuserform.html',{'form':form,'user':user,})
    ...
    if request.user.id==user.id and request.user.is_active:
        if request.user.is_authenticated():
            if request.POST:
                ...
                form=ChangeEmail()
            return render(request,'app1/userprofile/changeemailform.html',{'form':form,'user':user,})
    else:
        render(request,'app1/userprofile/error.html')

def saved(request):
    if request.user.is_authenticated():
        return render(request,'app1/userprofile/saved.html')
    else:
        return render(request,'app1/userprofile/error.html')

def password_change(request,template_name='app1/registration/password_change.html',post_change_redirect='app1/saved/'):
    return render(request,'app1/registration/password_change.html',{'form':form,})


def password_change_done(request,template_name='app1/userprofile/saved.html'):
    if request.user.is_authenticated():
        return render(request,'app1/userprofile/saved.html')
        ...
        if request.user.is_authenticated():
            if request.POST:
                ...
                if form.is_valid():
                    ...
                    Emailmsg.send()
                    return render_to_response('app1/emails/mailsent.html',{'user':user,})
            else:
                form=Dadsmail()
            return render(request,'app1/emails/sendmail.html',{'form':form,'user':user,})
    else:
        return render(request,'app1/userprofile/error.html')
